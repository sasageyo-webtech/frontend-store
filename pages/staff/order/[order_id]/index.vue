...
const orderId = useRoute().params.order_id; // ดึง order_id จาก URL
const orderDetails = ref(null); // เก็บข้อมูลการสั่งซื้อ
const paymentImage = ref(''); // เก็บ URL ของรูปใบเสร็จ

// ฟังก์ชันดึงข้อมูล order detail
...
onMounted(() => {
  fetchOrderDetails(); // เรียกใช้เมื่อคอมโพเนนต์ถูกเมาท์
});
</script>
